...
public abstract class Utils {
    /**
     * Parsing the runtime files generated by compiler. For example:
     * p4c-bm2-ss simple_router.p4 --p4v 14 --p4-runtime-file simple_router.proto.txt --p4runtime-format text
     * @param file runtime file path.
     * @return a P4Info instance build from runtime file.
     * @throws IOException
     */
    public static P4Info parseRuntimeInfo(String file) throws IOException {
        if (file == null) {
            throw new NullPointerException("Runtime file is null.");
        }
    ...
    /**
     * Parsing the device config file generated by the compiler. For example:
     ...
     */
    /**
     * Convert a string value to byte array.
     * @param str input string, only support ipv4 address, mac address and integer value now.
